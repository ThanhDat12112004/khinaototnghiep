    ...
    public class AccountController : Controller    {
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            var profileViewModel = new UserProfileViewModel
            {
                ...
                Avatar = null, // ApplicationUser doesn't have Avatar property
                Role = primaryRole,
                CreatedAt = user.CreatedAt,
                FavoriteMovies = new List<Phim>(), // TODO: Load from database if needed
                WatchHistory = new List<LichSuXem>(), // TODO: Load from database if needed
                EmailNotifications = true, // Default values since ApplicationUser doesn't have these
