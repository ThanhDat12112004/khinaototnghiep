...
namespace MoviesApp.Models
{
    ...
    public class Phim
    {
        ...
        [StringLength(20)]
        public string? DoTuoi { get; set; } // Độ tuổi như: 13+, 16+, 18+
        
        [NotMapped]
        public int? ThoiLuong => ThoiLuongPhim;        // Các thuộc tính OMDb
        [StringLength(500)]
        ...
        [NotMapped]
        public string? AnhDaiDien => AnhPhim;
        
        // Computed property for DiemDanhGia from ThongKePhim
        [NotMapped]
        public decimal? DiemDanhGia => ThongKePhim?.DiemTrungBinh;
    }
}
